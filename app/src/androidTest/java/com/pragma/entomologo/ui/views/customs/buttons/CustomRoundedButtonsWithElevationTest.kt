...
class CustomRoundedButtonsWithElevationTest {
    ...
    fun clickButton() {
        val text = "text"
        composeTestRule.setContent { CustomRoundedButtonsWithElevation(text = text, modifier = Modifier.testTag(TestTags.CUSTOM_BUTTON.id), onClick = {}) }
